...
# Function to encode LoRaWAN 1.1 downlink packet
def encode_downlink_packet(dev_eui, app_eui, app_key, payload):
    ...
    packet += bytes.fromhex('00')  # FCtrl for downlink packet

    # Add downlink payload
    packet += payload
...
payload = b'Downlink message'

downlink_packet = encode_downlink_packet(dev_eui, app_eui, app_key, payload)
print('Encoded downlink packet:', base64.b16encode(downlink_packet).decode('utf-8'))
