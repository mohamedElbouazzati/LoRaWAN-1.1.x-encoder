...
# Function to encode LoRaWAN 1.1 uplink packet
def encode_uplink_packet(dev_eui, app_eui, app_key, payload):
    ...
    packet += bytes.fromhex('01')  # FCtrl for uplink packet
...
uplink_packet = encode_uplink_packet(dev_eui, app_eui, app_key, payload)
print('Encoded uplink packet:', base64.b16encode(uplink_packet).decode('utf-8'))
